  ...
  return (
    <div className=" px-5 mt-10">
      ...
      <div className=" absolute ">
        <img src="https://i.ibb.co/kS9TMQ8/logo-dark.png" className=" xl:-mt-[380px] xl:ml-[475px]  lg:-mt-[240px]  md:ml-[475px] md:-mt-[390px] lg:ml-[675px] -mt-[480px] ml-[175px] text-black" alt="" />
        </div>
    </div>
  );
};
